...
export const FAQ_ITEMS_FIRST = [
  {
    ...
    answer: (
      <>
        ...
        lending to generate returns and earn rewards in the form of additional cryptocurrency.
        This process can be done manually by anyone in DeFi or automated via platforms such as 
        Harvest that maximize your returns with the latest yield strategies & auto-compounding mechanism.
      </>
    ),
  },
  {
      ...
      <>
        <ul>
          <li style={{ marginBottom: '20px' }}>
            Yield farming is a highly manual process and inconvenient for people that cannot keep up with the latest updates 24/7.
            Harvest automates the yield farming process by regularly harvesting & auto-compounding rewards at a significantly lower cost for users. 
          </li>
          <li style={{ marginBottom: '20px' }}>
            Harvest is one of the longest-running yield farming platforms in DeFi, 
            established in August 2020 with the native token FARM listed on trusted exchanges such as Coinbase, Binance, Kraken, and several other CEXs and DEXs.
          </li>
        </ul>
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        There is only a performance fee applied to your earned rewards (30% on Ethereum Network, 8% on other chains). 
        The APY values of our farms are estimated by taking the performance fee into account. 
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        It’s also proof of deposit. F_tokens can be redeemed anytime for DAI, USDC, or any other asset via our integration with Wido. 
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        or any other token deposited via Wido to be entitled to a part of the yield from all other farming strategies at Harvest. 
      </>
    ),
  },
  {
    ...
    answer: (
      <ul>
        ...
        <li style={{ marginBottom: '10px' }}>
          FARM has a total supply over 4 years of <b>690,420.</b> distributed over four years since the project’s inception in August 2020
        </li>
  ...
  },
  {
    ...
    answer: (
      <>
        See{' '}
        <a href="https://harvest-finance.gitbook.io/harvest-finance/general-info/how-to-use-1/how-to-understand-how-much-you-earn/apy-calculation" 
          target="_blank" rel="noopener noreferrer" >
        this article about APY calculation
        </a>
        {' '}and {' '}
        <a href="https://harvest-finance.gitbook.io/harvest-finance/general-info/how-to-use-1/how-to-understand-how-much-you-earn/interest-rate-guide" 
          target="_blank" rel="noopener noreferrer" >this one about your expected profits.
        </a>
        <br/><br/>
        <b>​Remember: the APY is estimated on past performance. The APY may go up or down due to several reasons:</b>
        <ul>
          <li>Governance decisions of the underlying platform</li>
          <li>Change of incentives like the number of emissions directed to profit share, 
            fundamental tokenomics or dynamics such as the 4% emission reduction every week</li>
          <li>Swings in the price of FARM token (which is used for incentives) can deviate the APY.</li>
          <li>Large changes in TVL may dilute rewards and reduce APY. </li>
          <li>Market volume in LP assets farmed can also have an impact on the APY movement as a high volume generally 
            in an LP position captures more fees driving up the APY.</li>
        </ul>
      </>
    ),
  },
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <a href="https://harvest-finance.gitbook.io/harvest-finance/general-info/security/audites" 
          target="_blank" rel="noopener noreferrer" >here.
        </a>
        <ul>
          <li>
            The Harvest smart contracts have been designed from the ground up with security in mind by using as many audited components as possible. 
            Please review the smart contracts before depositing funds.
          </li>
          <li>
...
export const FAQ_ITEMS_SECOND = [
  {
    ...
    answer: (
      <>
        ...
        When users (also referred to as farmers) deposit their assets into one of the farming strategies available in the app, 
        Harvest automatically puts them to work to earn the <b>highest yields</b> with these deposits in a ‘set & forget’ fashion.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        for example, $USDC into an $ETH farm. 
        Wido takes care of the token conversion for you at the best rates so that you don’t have to leave 
        Harvest to swap tokens elsewhere manually.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        From here, you can 1) use it for farming on Harvest to be entitled to all rewards, 2) take it to another DeFi platform for yield derivatives, 
        interest rates, or use as collateral. 
        <br/><br/>
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        Depending on network congestion, the fees can be temporarily higher than usual. We suggest coming back later for lower fees​. 
        (Tip: Sundays are usually low in network activity compared to the rest of the weekdays)
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        Then, to finally withdraw your fToken into your input token, e.g., USDC, hit the “Withdraw” button for the tokens to appear in your wallet, such as Metamask.
      </>
    ),
  },
  {
      ...
      <>
        ...
        <ul>
          ...
          <li>
            ...
            is a yield-bearing token for Harvest. It can be acquired by depositing FARM into the Profit-Sharing pool on 
            Ethereum Network with the <b>Use iFARM</b> checkbox.
          </li>
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        Its supply is limited to 690,420 tokens. FARM is also a cash flow token for Harvest. When Harvest’s farms generate yields, 
        70% (70% on Ethereum Network, 92% on other chains) of these yields are used to increase the value of the deposits. 
        The remaining 30% (30% on Ethereum Network, 8% on other chains) are converted into FARM tokens which are then used to reward farmers 
        who staked their FARM into the FARM pool on Ethereum Network. Hence the name ‘Profit-Sharing.’
        <br/><br/>
        The Profit-Sharing pool has implications for the value of iFARM - the yield-bearing FARM. iFARM is using the FARM pool under the hood. 
        iFARM acts as FARM staked in the Profit-Sharing pool. Its main advantages are 1) a lower gas cost, 2) transferability and 3) further 
        new utilities (e.g. lending collateralization).
        <br/><br/>
        You can read more{' '}
        <a href="https://harvest-finance.gitbook.io/harvest-finance/general-info/what-do-we-do/profit-sharing-pool-ps" target="_blank" rel="noopener noreferrer">
          here
        </a>
        {' '}and {' '}
        <a href="https://redmption.medium.com/flight-of-the-aggregator-1a687a1662ed" target="_blank" rel="noopener noreferrer">
          here
        </a>
  ...
  },
  {
    ...
    answer: (
      <div>
        ...
        The Rate is a forward-looking projection based on our good faith belief of how to project results over the relevant period reasonably, 
        but such belief is subject to numerous assumptions, risks and uncertainties (including smart contract security risks and third-party actions) 
        which could result in a materially different (lower or higher) token-denominated APR/APY. 
        The Rate is not a promise, guarantee, or undertaking on the part of any person or group of persons but depends entirely on the results 
        of the operation of smart contracts and other autonomous systems (including third-party systems) and 
        how third parties interact with those systems after the time of your deposit. 
        Even if the Rate is achieved as projected, you may still suffer a financial loss in fiat-denominated terms 
        if the fiat-denominated value of the relevant tokens (your deposit and any tokens allocated or distributed to you pursuant to the Rate) 
        declines during the deposit period.
      </div>
    ),
  },
  {
...
export const FAQ_TOTAL = FAQ_ITEMS_SECOND.reduce((result, current)=> result.concat(current), FAQ_ITEMS_FIRST).sort((a,b) => a.id - b.id);
...
export const HARVEST_EXTERNAL_API_URL =
  process.env.REACT_APP_HARVEST_EXTERNAL_API_URL
...
export const IFARM_DEPOSIT_TOOLTIP = (
  <>
    When unchecked, <b style={{textDecoration: "underline"}}>FARM</b> is deposited into <b style={{textDecoration: "underline"}}>FARM</b> Pool directly.
    <br /> When checked, <b style={{textDecoration: "underline"}}>FARM</b> is converted into <b style={{textDecoration: "underline"}}>iFARM</b>: the interest-bearing{' '}
    <b style={{textDecoration: "underline"}}>FARM</b> which grows in value over time
  </>
)
export const IFARM_WITHDRAW_TOOLTIP = (
  <>
    If you own <b style={{textDecoration: "underline"}}>iFARM</b>, check to withdraw from the <b style={{textDecoration: "underline"}}>iFARM</b> vault.
    <br /> Uncheck to withdraw all <b style={{textDecoration: "underline"}}>FARM</b> staked into <b>FARM Pool</b> directly
  </>
)
...
export const DEFAULT_CLAIM_HELP_MESSAGES = {
  FARM: (
    <div className="help-message">
      ...
      <ol className="numeric-list">
        <li>
          Hit &quot;Claim rewards&quot; to claim your <b style={{textDecoration: "underline"}}>FARM</b>
        </li>
        <li>
          To earn additional interest on your <b style={{textDecoration: "underline"}}>FARM</b>, stake your claimed <b style={{textDecoration: "underline"}}>FARM</b> into the{' '}
          <b style={{textDecoration: "underline"}}>FARM</b> pool. We recommend claiming and re-staking your <b style={{textDecoration: "underline"}}>FARM</b> rewards into the{' '}
          <b style={{textDecoration: "underline"}}>FARM</b> pool periodically (for example, weekly)
        </li>
      </ol>
    </div>
  ),
  MIGRATED_TO_HODL: (
    <div className="help-message">
      ...
      <ol className="numeric-list">
        <li>
          Hit &quot;Claim FARM&quot; to claim your <b style={{textDecoration: "underline"}}>FARM</b>
        </li>
        <li>
          To earn additional interest on your <b style={{textDecoration: "underline"}}>FARM</b>, stake your claimed <b style={{textDecoration: "underline"}}>FARM</b> into the{' '}
          <b style={{textDecoration: "underline"}}>FARM</b> pool. We recommend claiming and re-staking your <b style={{textDecoration: "underline"}}>FARM</b> rewards into the{' '}
  ...
  IFARM: (
    <div className="help-message">
      ...
      <ol className="numeric-list">
        <li>
          Hit &quot;Claim rewards&quot; to claim your <b style={{textDecoration: "underline"}}>iFARM</b>
        </li>
        <li>
          Your <b style={{textDecoration: "underline"}}>iFARM</b> earns interest automatically, you do not need to stake it
        </li>
      </ol>
    </div>
  ),
  HODL: (
    <div className="help-message">
      ...
      <ol className="numeric-list">
        <li>
          Hit &quot;Claim rewards&quot; to claim your <b style={{textDecoration: "underline"}}>iFARM</b> and <b style={{textDecoration: "underline"}}>fSUSHI</b>
        </li>
        <li>
          To redeem <b style={{textDecoration: "underline"}}>fSUSHI</b> for <b style={{textDecoration: "underline"}}>SUSHI</b>, withdraw from the <b style={{textDecoration: "underline"}}>SUSHI</b> vault on the same
          page
        </li>
      </ol>
    </div>
  ...
  bFARM: (
    <div className="help-message">
      ...
      <ol className="numeric-list">
        <li>
          Hit &quot;Claim rewards&quot; to claim your <b style={{textDecoration: "underline"}}>bFARM</b>
        </li>
        <li>
          To earn additional interest on your <b style={{textDecoration: "underline"}}>bFARM</b>, you can bridge <b style={{textDecoration: "underline"}}>bFARM</b> into{' '}
          <b style={{textDecoration: "underline"}}>FARM</b> using{' '}
          <a href="https://anyswap.exchange/bridge" target="_blank" rel="noopener noreferrer">
            Anyswap
          </a>{' '}
          and stake it into the <b style={{textDecoration: "underline"}}>FARM</b> pool. We recommend doing so periodically (for example,
          weekly)
        </li>
      </ol>
    </div>
  ...
  miFARM: (
    <div className="help-message">
      ...
      <ol className="numeric-list">
        <li>
          Hit &quot;Claim rewards&quot; to claim your <b style={{textDecoration: "underline"}}>miFARM</b>
        </li>
        <li>
          Your <b style={{textDecoration: "underline"}}>miFARM</b> earns interest automatically, you do not need to stake it
        </li>
      </ol>
    </div>
  ),
...
export function fromWEI(number, digit){
    return BigNumber(number).shiftedBy(-1 * digit).toNumber();
}
