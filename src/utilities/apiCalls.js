...
export const getLastHarvestInfo = async (address, chainId, retries = 3, delayMs = 1000) => {
  let result = ''
...
export const getPublishDate = async (retries = 3, delayMs = 1000) => {
  const allData = [],
    allFlags = []
...
export const getSequenceId = async (address, chainId, retries = 3, delayMs = 1000) => {
  let vaultTVLCount,
    vaultPriceFeedCount,
    vaultsFlag = true
...
export const getVaultHistories = async (address, chainId, retries = 3, delayMs = 1000) => {
  let vaultHData = {},
    vaultHFlag = true
...
export const getUserBalanceVaults = async (account, retries = 3, delayMs = 1000) => {
