...
export function ThemeProvider({ children }) {
  ...
  const borderColor = darkMode ? "rgba(217, 217, 217, 0.5)" : "#E9E9E9"
  ...
  const switchDarkIconFilter = darkMode ? "invert(49%) sepia(95%) saturate(814%) hue-rotate(2deg) brightness(106%) contrast(103%)" : ""
  const switchLightIconFilter = darkMode ? "" : "invert(49%) sepia(95%) saturate(814%) hue-rotate(2deg) brightness(106%) contrast(103%)"
  ...
  const sidebarEffect = darkMode ? 'box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5)' : 'border: 1px solid #E9E9E9'
  ...
  const narrowIconColor = darkMode ? 'invert(100%) sepia(1%) saturate(0%) hue-rotate(213deg) brightness(104%) contrast(100%)' : ''

  const toggleColor = darkMode ? 'invert(100%) sepia(100%) saturate(0%) hue-rotate(288deg) brightness(102%) contrast(102%)' : ''
  ...
  const widoBackIconColor = darkMode ? '' : 'invert(59%) sepia(42%) saturate(2316%) hue-rotate(359deg) brightness(101%) contrast(107%)'

  const vaultPanelHoverColor = darkMode ? '#222f3c' : '#f8f8f9'
  const socialBackColor = darkMode ? "white" : "#15202B"
  const socialIconColor = darkMode ? '' : 'invert(92%) sepia(6%) saturate(22%) hue-rotate(195deg) brightness(107%) contrast(107%)'

  const searchBackColor = darkMode ? '#15202B' : '#F5F5F5'
  const searchBorderColor = darkMode ? "rgba(217, 217, 217, 0.5)" : "none"
  const searchIconColor = darkMode ? 'invert(100%) sepia(20%) saturate(0%) hue-rotate(40deg) brightness(104%) contrast(101%)' : ''
  ...
  const widoTagBoxShadow = darkMode ? '0px 1px 3px rgba(16, 24, 40, 0.1), 0px 1px 2px rgba(16, 24, 40, 0.06)' : '0px 1px 3px rgba(16, 24, 40, 0.1), 0px 1px 2px rgba(16, 24, 40, 0.06)'
  ...
  const widoInputBoxShadow = darkMode ? '0px 1px 2px rgba(16, 24, 40, 0.05)' : '0px 1px 2px rgba(16, 24, 40, 0.05)'
  ...
  return (
    <ThemeContext.Provider value={{ darkMode, setDarkMode, switchMode, pageBackColor, fontColor, backColor, borderColor, filterColor, boxShadowColor, hoverImgColor,
      ...
      dashboardListItemPercentBack, dashboardListItemPercentColor, filterChainHoverColor,
      badgeIconBackColor, narrowIconColor, toggleColor, mobileFilterBackColor, mobileFilterBorderColor, mobileFilterDisableColor,
      toggleBackColor, switchBalance, setSwitchBalance, connectWalletBtnBackColor, connectWalletBtnHoverBackColor, chartBtnGroupBackColor,
      widoDetailDividerColor, widoBackBtnBackColor, widoBackBtnBackHoverColor, widoBackIconColor, vaultPanelHoverColor, socialBackColor,
      socialIconColor, searchBackColor, searchBorderColor, searchIconColor, widoDepoTokenListActiveColor, widoDepoTokenListHoverColor,
      widoSwitchTagBorderColor, widoSwitchTagBackColor, widoTagBackColor, widoTagBoxShadow, widoTagFontColor, widoTagActiveFontColor,
      widoInputPanelBorderColor, widoInputBoxShadow, widoSelTokenSubTitleColor, toggleInactiveBackColor, toggleActiveBackColor,
      sidebarFontColor, sidebarActiveFontColor }}>
      {children}
