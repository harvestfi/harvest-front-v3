...
module.exports = {
  ...
  quickGamma_MATIC_ETH_narrow: {
    ...
    logoUrl: ['./icons/quick.svg', './icons/matic.svg', './icons/eth.svg'],
  ...
  quickGamma_MATIC_USDC_narrow: {
    isNew: true,
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/quick.svg', './icons/matic.svg', './icons/usdc.svg'],
    apyIconUrls: ['./icons/quick.svg', './icons/matic.svg'],
    apyTokenSymbols: ['dQUICK', 'WMATIC'],
    subLabel: 'Narrow',
  ...
  balancer_tetuBal: {
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/balancer.svg', './icons/80bal-20eth.png', './icons/tetu-bal.png'],
    apyIconUrls: ['./icons/balancer.svg'],
    apyTokenSymbols: ['BAL'],
  ...
  bal_MaticX: {
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/balancer.svg', './icons/matic.svg', './icons/maticx.svg'],
  ...
  bal_stMatic: {
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/balancer.svg', './icons/stmatic.svg', './icons/matic.svg'],
    apyIconUrls: ['./icons/balancer.svg', './icons/ldo.svg'],
    apyTokenSymbols: ['BAL', 'LDO'],
  ...
  meshswap_WMATIC_MESH: {
    inactive: true,
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/mesh.png', './icons/matic.svg', './icons/mesh.png'],
    apyIconUrls: [],
    apyTokenSymbols: [],
  ...
  meshswap_WMATIC_USDC: {
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/mesh.png', './icons/matic.svg', './icons/usdc.svg'],
  ...
  meshswap_WMATIC_USDT: {
    chain: CHAINS_ID.MATIC_MAINNET,
    logoUrl: ['./icons/mesh.png', './icons/matic.svg', './icons/usdt.svg'],
    apyIconUrls: ['./icons/mesh.png'],
    apyTokenSymbols: ['MESH'],
