...
const WidoDepositStartSlippage = ( { startSlippage, setStartSlippage, setSlippagePercent, setDepositWido } ) => {
  ...
  return (
    <SelectTokenWido show={ startSlippage } backColor={backColor}>
      ...
      <Button width={"100%"} height={"50px"} color="wido-save" padding={"17px"} onClick={()=>{
